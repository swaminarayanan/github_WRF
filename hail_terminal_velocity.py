...
lons1 = ds12['hailcast_d']['lon'].values
lats1 = ds12['hailcast_d']['lat'].values
...
##################################################
###masking the lon, lats in dataset
...
# terminal_velocities1 = terminal_velocities1.where(mask == 1)
# terminal_velocities2 = terminal_velocities2.where(mask == 1)

terminal_velocities1 = np.where(mask == 1, terminal_velocities1, np.nan)
terminal_velocities2 = np.where(mask == 1, terminal_velocities2, np.nan)
