...
# Load the dataset
ds11 = xr.open_dataset(r'/media/lab/My Passport/hail/milbrandt_20190315.nc')
...
ds1 = ds11['rainnc'].isel(time=48).squeeze()#.values
ds2 = ds22['rainnc'].isel(time=48).squeeze()#.values
...
pcm1 = ax1.contourf(lons1, lats1, ds1, cmap='jet')
...
pcm2 = ax2.contourf(lons2, lats2, ds2, cmap='jet')
